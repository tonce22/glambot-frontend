...
export const T = {
  ...
  ka: {
    ...
    hero: {
      tag: 'ქორწილი და ღონისძიებები',
      h1a: 'შეინახე შენი',
      h1em: 'სილამაზე',
      h1b: 'მოძრაობაში',
      sub: 'პროფესიული Glambot სლოუ-მოუშენ ვიდეო სერვისი ქორწილებისა და ღონისძიებებისთვის საქართველოში. დაუვიწყარი მომენტები, მარადიულად შენახული.',
      btn1: 'სერვისები',
      btn2: 'დაჯავშნე',
    },
    about: {
      ...
      h: 'სლოუ მოუშენის',
      hem: 'ხელოვნება',
      frame: 'სლოუ მოუშენ მაგია',
      p1: 'Glambot Georgia მოგიტანთ ჰოლივუდური სლოუ მოუშენის გამოცდილებას თქვენს ყველაზე განსაკუთრებულ დღესასწაულებზე. ჩვენ ვიპყრობთ ყველა ჯადოსნურ მომენტს — კაბის ტრიალს, კონფეტის ფეთქებას, პირველ ცეკვას.',
      p2: 'როგორც ინდივიდუალური მეწარმე, ჩვენ გთავაზობთ პერსონალურ სერვისს თითოეული კლიენტისთვის. თქვენი დღესასწაული უნიკალურია, და თქვენი Glambot ვიდეოც ასე უნდა იყოს.',
      events: 'ღონისძიება',
      slowmo: 'სლოუ მოუშენი',
      res: 'გარჩევადობა',
    },
    services: {
      ...
      s1: { name: 'საქორწილო Glambot', desc: 'სრული დღის გადაღება ჩვენი Glambot-ით. ცერემონია, ბანქეტი და ყველა ლამაზი მომენტი.' },
      s2: { name: 'ღონისძიების გადაღება', desc: 'კორპორატიული ღონისძიებები, დაბადების დღეები და კერძო წვეულებები. სლოუ მოუშენი ნებისმიერ დღესასწაულზე.' },
      s3: { name: 'ჰაილაით ვიდეო', desc: 'პროფესიულად დამონტაჟებული სლოუ მოუშენ ვიდეო 48 საათში. სამუდამო მოგონება.' },
    },
    gallery: {
      tag: 'ჩვენი ნამუშევარი',
      h: 'მომენტები',
      hem: 'გაყინული დროში',
      items: ['საქორწილო ვიდეო 2024', 'პირველი ცეკვა', 'თაიგულის სროლა', 'ბანქეტის მომენტები', 'დღესასწაულები'],
    },
    contact: {
      tag: 'დაგვიკავშირდით',
      h: 'დაჯავშნე',
      hem: 'Glambot',
      p: 'მზად ხართ კინემატოგრაფიული სლოუ მოუშენი დაამატოთ თქვენს განსაკუთრებულ დღეს? დაგვიკავშირდით ხელმისაწვდომობის შესამოწმებლად.',
      phone: 'ტელეფონი',
      owner: 'მფლობელი',
      location: 'მდებარეობა',
      loc: 'საქართველო',
