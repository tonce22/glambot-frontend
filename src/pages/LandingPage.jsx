        ...
        <div className={styles.aboutGrid}>
          ...
          <div>
            ...
            <div className={styles.aboutStats}>
              <div className={styles.stat}><div className={styles.statN}>120+</div><div className={styles.statL}>{t.about.events}</div></div>
              <div className={styles.stat}><div className={styles.statN}>240fps</div><div className={styles.statL}>{t.about.slowmo}</div></div>
              <div className={styles.stat}><div className={styles.statN}>4K</div><div className={styles.statL}>{t.about.res}</div></div>
            </div>
          </div>
        </div>
      </section>
